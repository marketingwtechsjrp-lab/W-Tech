...
const copies: Record<LPLanguage, Record<SuspensionFunnelAngle, SuspensionFunnelCopy>> = {
    'pt-BR': {
        controle: {
            ...
            vslSubtitle: 'Nesta aula, você vai entender por que uma moto imprevisível quase sempre começa por uma base de acerto errada — e como corrigir isso.',
        ...
        ergonomia: {
            ...
            vslSubtitle: 'Nesta aula, você vai descobrir como ergonomia e suspensão trabalham juntas para reduzir fadiga sem sacrificar controle.',
        ...
        tracao: {
            ...
            vslSubtitle: 'Nesta aula, você vai ver como SAG e cliques mudam a leitura do terreno, a tração e a confiança para acelerar.',
    ...
    'pt-PT': {
        controle: {
            ...
            vslSubtitle: 'Nesta aula, vais perceber por que uma mota imprevisível começa quase sempre numa base de afinação errada — e como corrigi-la.',
        ...
        ergonomia: {
            ...
            vslSubtitle: 'Nesta aula, vais descobrir como ergonomia e suspensão trabalham juntas para reduzir fadiga sem perder controlo.',
        ...
        tracao: {
            ...
            vslSubtitle: 'Nesta aula, vais ver como SAG e cliques mudam a leitura do terreno, a tração e a confiança para acelerar.',
    ...
    es: {
        controle: {
            ...
            vslSubtitle: 'En esta clase entenderás por qué una moto impredecible casi siempre comienza con una mala base de ajuste y cómo corregirla.',
        ...
        ergonomia: {
            ...
            vslSubtitle: 'En esta clase descubrirás cómo ergonomía y suspensión trabajan juntas para reducir la fatiga sin perder control.',
        ...
        tracao: {
            ...
            vslSubtitle: 'En esta clase verás cómo el SAG y los clics cambian la lectura del terreno, la tracción y la confianza para acelerar.',
    ...
    en: {
        controle: {
            ...
            vslSubtitle: 'In this class, you will learn why an unpredictable bike usually starts with the wrong setup baseline — and how to fix it.',
        ...
        ergonomia: {
            ...
            vslSubtitle: 'In this class, you will see how ergonomics and suspension work together to reduce fatigue without giving up control.',
        ...
        tracao: {
            ...
            vslSubtitle: 'In this class, you will see how sag and clickers change terrain feedback, traction and the confidence to accelerate.',
