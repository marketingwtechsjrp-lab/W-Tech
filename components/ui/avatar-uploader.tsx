...
export function AvatarUploader({
	...
	return (
		...
		>
			...
			<ModalContent className="h-max md:max-w-md max-h-[90vh] overflow-y-auto">
				<ModalHeader>
				...
				<ModalBody className="space-y-4 pt-4">
					...
					/>
					{photo?.file && (
						<div className="bg-accent relative aspect-square w-full overflow-hidden rounded-lg min-h-[300px]">
							<Cropper
								image={photo.url}
								crop={crop}
								zoom={zoom}
				...
				<ModalFooter className="grid w-full grid-cols-2 gap-4">
					<Button
						className="w-full"
						variant="outline"
						disabled={isPending}
