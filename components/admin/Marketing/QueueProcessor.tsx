...
const QueueProcessor: React.FC<QueueProcessorProps> = ({ campaign, onComplete }) => {
    ...
    return (
        <div className="bg-[var(--admin-surface-1)] border-l-4 border-purple-600 dark:border-purple-500 shadow-lg rounded-r-lg p-4 mb-6 animate-in slide-in-from-top-2">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h4 className="font-bold text-[var(--admin-text-primary)] flex items-center gap-2">
                            Enviando Campanha: {campaign.name}
                        </h4>
                        <div className="text-xs text-[var(--admin-text-secondary)] flex gap-4 mt-1">
                ...
                <div className="flex items-center gap-6">
                    ...
                    {isProcessRunning && countdown > 0 && (
                        <div className="text-center">
                            <span className="text-2xl font-black text-[var(--admin-text-tertiary)]">{countdown}s</span>
                    ...
                    <div className="flex items-center gap-2">
                        <button onClick={togglePause} className="p-2 bg-[var(--admin-surface-3)] hover:bg-gray-200 dark:hover:bg-[#444] rounded-full text-[var(--admin-text-secondary)]">
            ...
            {lastProcessed && (
                <div className="mt-2 bg-[var(--admin-surface-2)] p-2 rounded text-xs text-[var(--admin-text-secondary)] flex items-center gap-2">
