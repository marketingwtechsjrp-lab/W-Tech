        ...
        <div className="min-h-screen font-sans bg-[#050505] text-white selection:bg-[#d40000] selection:text-white overflow-x-hidden">
            ...
            <header className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-20 text-center">
                    <div className="inline-flex items-center gap-2 border border-white/20 bg-white/5 backdrop-blur-md px-4 py-1.5 rounded-full mb-8 animate-fade-in-down">
                        ...
                        <span className="text-xs font-black uppercase tracking-[0.3em] text-gray-300">Lisboa será o centro da suspensão mundial</span>
                    </div>
            ...
            <section className="py-24 bg-[#050505]">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <span className="text-[#d40000] font-black uppercase tracking-[0.3em] text-[10px] md:text-xs">Exclusividade Total</span>
                        <h2 className="text-4xl md:text-6xl font-black uppercase mt-4 mb-8 tracking-tighter">Por que este curso é tão <br />importante?</h2>
                    </div>
            ...
            <section className="py-24 bg-white text-black relative">
                <div className="container mx-auto px-6 relative z-10">
                    <h2 className="text-4xl md:text-7xl font-black uppercase mb-12 tracking-tighter max-w-4xl leading-[0.9]">
                        O Que Você Vai <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#d40000] to-red-500 font-black">Dominar</span>
                    </h2>
            ...
            <section className="py-24 bg-zinc-900 border-b border-white/5">
                <div className="container mx-auto px-6 text-center">
                    <span className="text-[#d40000] font-black uppercase tracking-[0.3em] text-[10px] md:text-xs">Público Alvo</span>
                    <h2 className="text-4xl md:text-6xl font-black uppercase mt-4 mb-12 tracking-tighter">Para quem é este curso?</h2>
