...
export interface LandingPage {
  ...
  handsOnEnabled?: boolean; // Mapped from hands_on_enabled — exibe bloco "100% mão na massa" (padrão true)
  template?: import('./lib/landingTemplates').LandingTemplateId;
  sectionOrder?: { id: string; enabled: boolean }[]; // Ordem/visibilidade das seções (V9+); null = padrão
